...
public class HTableModuloExprImpl extends HTableExprImpl implements HTableModuloExpr {

  public HTableModuloExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  @Override
  public void accept(@NotNull HTableVisitor visitor) {
    visitor.visitModuloExpr(this);
  }
